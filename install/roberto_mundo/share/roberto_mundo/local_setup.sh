...
: ${AMENT_CURRENT_PREFIX:="/root/ROS2/Roberto/install/roberto_mundo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/roberto_mundo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/roberto_mundo/environment/path.sh"
